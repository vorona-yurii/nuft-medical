...
$.extend($.jgrid,{
	...
	search : {
	    ...
	    Find: "Leita",
	    Reset: "Endursetja",
	    odata: [{ oper:'eq', text:"sama og"},{ oper:'ne', text:"ekki sama og"},{ oper:'lt', text:"minna ru"},{ oper:'le', text:"minna eða jafnt og"},{ oper:'gt', text:"stærra ru"},{ oper:'ge', text:"stærra eða jafnt og"},{ oper:'bw', text:"byrjar á"},{ oper:'bn', text:"byrjar ekki á"},{ oper:'in', text:"er í"},{ oper:'ni', text:"er ekki í"},{ oper:'ew', text:"endar á"},{ oper:'en', text:"endar ekki á"},{ oper:'cn', text:"inniheldur"},{ oper:'nc', text:"inniheldur ekki"},{ oper:'nu', text:'is null'},{ oper:'nn', text:'is not null'}],
	...
	edit : {
	    ...
	    msg: {
	        ...
	        minValue:"gildi verður að vera meira ru eða jafnt og ",
	        maxValue:"gildi verður að vera minna ru eða jafnt og ",
